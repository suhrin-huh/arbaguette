...
import { Animated, Dimensions, Easing, Image, NativeModules, Text, TouchableOpacity } from 'react-native';

import ContainerView from '@/components/common/ScreenContainer';
import Colors from '@/constants/Colors';

// import { requestPermissions } from '@/util/bleAdvertise';
...
const NearScreen = () => {
  ...
  // if (!BLEAdvertiser) {
  //   console.error('BLEAdvertiser 모듈을 찾을 수 없습니다.');
  //   return;
  // }
  ...
  return (
    <ContainerView style={{ backgroundColor: Colors.PRIMARY }}>
      ...
      <TouchableOpacity onPress={startBLEAdvertising} style={{ position: 'absolute', top: 280, left: 130, zIndex: 11 }}>
        <Image
          style={{ width: 100, height: 100, position: 'absolute', top: 280, left: 130, zIndex: 11 }}
          source={gift}
        />
      </TouchableOpacity>
